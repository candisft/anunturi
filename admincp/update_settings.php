...
{	
	...
	$Currency			= $mysqli->escape_string($_POST['inputCurrency']);
...
// Insert info into database table.. do w.e!
	$mysqli->query("UPDATE settings SET name='$SiteTitle',siteurl='$SiteLink',keywords='$MetaKeywords',descrp='$MetaDescription',email='$SiteEmail',country='$Country',currency='$Currency',fbapp='$FBApp',fbpage='$FBPage',twitter='$TwitterLink',pinterest='$PinterestLink',gplus='$GooglePlusLink',active='$Approve',template='$Template' WHERE id=1");
