...
?>        
            ...
            <tr class="btnDelete" data-id="<?php echo $Row['id'];?>">
                ...
                <td><a data-toggle="modal" href="user_info.php?id=<?php echo $Row['id'];?>" data-target="#userModal"><?php echo ucfirst($Row['username']);?></a></td>
                ...
                <a class="btn btn-info" data-toggle="modal" href="user_info.php?id=<?php echo $Row['id'];?>" data-target="#userModal">User Info</a>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <p class="text-danger"><small>Please note that all the ads posted by this user will also be deleted.</small></p>
