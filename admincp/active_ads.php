...
<div class="page-header">
  <h3>Active Ads <small>Manage active ads</small></h3>
</div>
...
$('button.btnDisapprove').on('click', function (e) {
    e.preventDefault();
    var id = $(this).closest('tr').data('id');
    $('#pedningModal').data('id', id).modal('show');
});

$('#btnDisapproveYes').click(function () {
    var id = $('#pedningModal').data('id');
	var dataString = 'id='+ id ;
    $('[data-id=' + id + ']').remove();
    $('#pedningModal').modal('hide');
	//ajax
	$.ajax({
type: "POST",
url: "disapprove_ad.php",
data: dataString,
cache: false,
success: function(html)
{
...
// How many adjacent pages should be shown on each side?
	...
	$q= $mysqli->query("SELECT * FROM ads WHERE active='1' ORDER BY id DESC limit $start,$limit");
...
<!--Approve Modal-->
<div class="modal fade" id="pedningModal" tabindex="-1" role="dialog" aria-labelledby="pedningModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
            ...
            <div class="modal-body">
				 ...
				 <p class="text-info"><small>You can re-activate this ad by navigating to Ads > Pending Ads.</small></p>	
            </div>
            <!--/modal-body-collapse -->
            <div class="modal-footer">
...
<div class="modal fade" id="FeatModal" tabindex="-1" role="dialog" aria-labelledby="FeatModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                 <p> Are you sure you want to make this ad FEATURED?</p>
				 <p class="text-info"><small>You can un-feature this ad by clicking unFeat button.</small></p>	
            </div>
            <!--/modal-body-collapse -->
            <div class="modal-footer">
...
<div class="modal fade" id="unFeatModal" tabindex="-1" role="dialog" aria-labelledby="unFeatModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                 <p> Are you sure you want to make this ad UN-FEATURED?</p>
				 <p class="text-info"><small>You can feature this ad again by clicking mkFeat button.</small></p>	
            </div>
            <!--/modal-body-collapse -->
            <div class="modal-footer">
