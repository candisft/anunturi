...
<?php $menu = build_categories(0, $menu_categories);?>			
      ...
      <?php if(!isset($_SESSION['username'])){?>      
        <li><a href="login.html"><i class="fa fa-user navbar-icon"></i> Login</a></li>
        <?php  }else{ ?>
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user navbar-icon"></i>  Account <span class="caret"></span></a>
          <ul class="dropdown-menu">            
            <li><a href="my_ads-recent-1.html">My Ads</a></li>
            <li><a href="favorites-recent-1.html">Favorites</a></li>
        ...
        <?php }?>
 		<li><a href="post.html">Post Your Ad</a></li>
