...
$ad_img = "http://".$site_link."/uploads/".$feat_image;

}else{

$ad_img = "http://".$site_link."/templates/".$site_template."/images/no_img.png";
...
$mysqli->query("UPDATE ads SET views=views+1 WHERE id='$id'");
...
<head>
<meta charset="utf-8">
<title><?php echo $full_title;?> | <?php echo $site_title;?></title>
<meta name="description" content="<?php echo $sort_description;?>" />
...
<meta property="og:url"             content="http://<?php echo $site_link;?>/ad-<?php echo $id;?>-<?php echo $page_link;?>.html" /> 
<meta property="og:title"           content="<?php echo $full_title;?> | <?php echo $site_title;?>" />
<meta property="og:description" 	content="<?php echo $sort_description;?>" /> 
<meta property="og:image"           content="<?php echo $ad_img;?>" /> 
